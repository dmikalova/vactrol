...
| Composite                                | Ordered/branching effects hold child effects, so complex cards are built by composition, not a bespoke fused node.                         | `Sequence`, `Sentences`, `Conditional`, `ChooseHouseThen`, `Repeat`.                                                                                                                                     | engine `AGENTS.md`; style-guide |
