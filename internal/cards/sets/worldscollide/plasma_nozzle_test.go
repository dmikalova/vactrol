...
func TestPlasmaNozzle(t *testing.T) {
	t.Run("host deals 2 to the fought creature and 2 splash to its neighbors", func(t *testing.T) {
		...
		// Before Fight deals 2 to the fought creature, then the 4-power host
		// deals its fight damage, for 6 total.
