...
var optionRank = map[string]int{
	...
	"WithTraits":   5,
	"WithKeywords": 6,
	// Every other in-play modifier shares one rank: their order among each other
	// is not constrained, only that they follow the descriptors and precede the
	// abilities.
	"WithAssault":                 7,
	"WithHazardous":               7,
	"WithSplashAttack":            7,
	"WithAttackDamage":            7,
	"WithNoDamageWhenAttacked":    7,
	"WithAttackIgnores":           7,
	"WithAttackKeywords":          7,
	"WithFriendlyEntersPlayReady": 7,
	"WithFightRestriction":        7,
	"WithCannotBeUsedTo":          7,
	"WithDestroyedWhen":           7,
	"WithTakesDamageFor":          7,
	"WithRestrictions":            7,
	"WithHouseLock":               7,
	"WithKeyCost":                 7,
	"WithPlayPermission":          7,
	"WithReplaces":                7,
	"WithDrawModifier":            7,
	...
	"WithPlayReap":      8,
	"WithPlayFightReap": 8,
	// Deck-generation sidecar options come last.
	"RarityWeight":   9,
	"OneCopyPerDeck": 9,
	"Template":       9,
}
