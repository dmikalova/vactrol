...
//
// It lives outside package game on purpose: set packages import the engine (via
...
import (
	"github.com/dmikalova/vactrol/internal/game/card"

	_ "github.com/dmikalova/vactrol/internal/game/cards/callofthearchons"
)
