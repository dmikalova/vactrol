// Package game implements the core rules engine for Vactrol, a KeyForge-style
...
const (
	// TriggerPlay fires when the card is played from hand.
	TriggerPlay Trigger = iota
	// TriggerReap fires when a creature is used to reap.
	TriggerReap
	// TriggerFight fires when a creature is used to fight.
	TriggerFight
