...
// artifactsCopy returns a fresh slice of a player's artifact ids, safe to hold
// across state mutations (e.g. while returning each artifact to its deck).
func (g *Game) artifactsCopy(player int) []LocalID {
