...
// TestItIsAmongFoughtMostPowerful covers the Before Fight condition Baldric the
// Bold reads: unmet when there is no fought creature, unmet when an enemy creature
// has strictly greater power, and met when the fought creature ties for or exceeds
