...
func LogEntrySamples() []LogEntry {
	return []LogEntry{
		...
		CardsDrawn{Player: 1, Cards: 3, Hand: 6},
		CardsDrawn{Player: 1, Cards: 1, Hand: 6},
		CardsDrawn{Player: 0, Cards: 0, Hand: 2},
		CardsDrawnBy{Player: 0, Cards: 1},
		...
		AemberMovedToCommonSupply{Card: 7, Amount: 1},
		...
		// Zones.
		ArchivesTakenIntoHand{Player: 0, Cards: 2},
		...
		ArchivesDiscarded{Player: 1, Cards: 3},
		...
		UpgradeDiscarded{Upgrade: 9, Host: 2},
